...
test_endpoint(lookup_event_player_results_by_event_id, 528358)  # not working for chosen event_id's
test_endpoint(lookup_table_by_league_and_season, 4335, '2024-2025')
test_endpoint(lookup_equipment_by_team_id, 133597)

# schedule functions
test_endpoint(events_last_5_by_team_id, 133738)
test_endpoint(events_by_round, 4335, 1, '2024-2025')
test_endpoint(events_in_league_by_season, 4335, '2024-2025')
