...
@premium_required
def events_next_5_by_team_id(team_id: int) -> str:
    """
...
@premium_required
def events_next_25_by_league_id(league_id: int) -> str:
    """
...
@premium_required
def events_last_15_by_league_id(league_id: int) -> str:
    """
...
@premium_required
def events_on_day(day: str, sport: str = None, league: str = None) -> str:
    """
...
@premium_required
def tv_events_on_day(day: str = None, sport: str = None, station_country: str = None, channel: str = None) -> str:
    """
