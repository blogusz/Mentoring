...
@premium_required
def lookup_league_details_by_id(league_id: int) -> str:
    """
...
@premium_required
def lookup_team_details_by_id(team_id: int) -> str:
    """
...
@premium_required
def lookup_event_details_by_id(event_id: int) -> str:
    """
...
@premium_required
def lookup_event_statistics_by_id(event_id: int) -> str:
    """
...
@premium_required
def lookup_event_lineup_by_id(event_id: int) -> str:
    """
...
@premium_required
def lookup_event_timeline_by_id(event_id: int) -> str:
    """
...
@premium_required
def lookup_event_tv_by_id(event_id: int) -> str:
    """
